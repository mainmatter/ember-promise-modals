/*! For license information please see chunk.524.8ecfb6d55d15b1f14f52.js.LICENSE.txt */
var __ember_auto_import__;(()=>{var e={952:(e,t,n)=>{"use strict"
n.r(t),n.d(t,{default:()=>s})
var o=n(296),r=n.n(o),i=n(672),a=(0,n(894).createTemplateFactory)({id:"GmS2yzEb",block:'[[[42,[28,[37,1],[[28,[37,1],[[30,0,["modals","_stack"]]],null]],null],null,[[[1,"  "],[10,0],[15,0,[29,["epm-backdrop ",[52,[30,1,["isClosing"]],"epm-out"]]]],[14,"tabindex","-1"],[14,"role","presentation"],[14,"aria-hidden","true"],[15,"data-test-epm-backdrop",[29,[[30,2]]]],[12],[13],[1,"\\n  "],[10,0],[14,0,"epm-modal-container"],[12],[1,"\\n    "],[8,[39,3],[[16,"data-test-epm-modal",[29,[[30,2]]]]],[["@modal"],[[30,1]]],null],[1,"\\n  "],[13],[1,"\\n"]],[1,2]],null]],["modal","index"],false,["each","-track-array","if","epm-modal"]]',moduleName:"/home/runner/work/ember-promise-modals/ember-promise-modals/packages/ember-promise-modals/dist/components/epm-modal-container.js",isStrictMode:!1}),s=(0,o.setComponentTemplate)(a,r().extend({tagName:"",modals:(0,i.inject)()}))},840:(e,t,n)=>{"use strict"
n.r(t),n.d(t,{default:()=>L})
var o=n(296),r=n.n(o),i=n(886),a=n(208)
const s=require("@ember/object/internals")
var l=n(672),c=["input","select","textarea","a[href]","button","[tabindex]:not(slot)","audio[controls]","video[controls]",'[contenteditable]:not([contenteditable="false"])',"details>summary:first-of-type","details"],u=c.join(","),d="undefined"==typeof Element,p=d?function(){}:Element.prototype.matches||Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector,m=!d&&Element.prototype.getRootNode?function(e){return e.getRootNode()}:function(e){return e.ownerDocument},f=function(e,t,n){var o=Array.prototype.slice.apply(e.querySelectorAll(u))
...
o.flatten?r.push.apply(r,m):r.push({scope:a,candidates:m})}else i.unshift.apply(i,a.children)}}return r},v=function(e,t){return e.tabIndex<0&&(t||/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName)||e.isContentEditable)&&isNaN(parseInt(e.getAttribute("tabindex"),10))?0:e.tabIndex},h=function(e,t){return e.tabIndex===t.tabIndex?e.documentOrder-t.documentOrder:e.tabIndex-t.tabIndex},y=function(e){return"INPUT"===e.tagName},g=function(e){var t=e.getBoundingClientRect(),n=t.width,o=t.height
...
return!r||r===e}(e)}(t)||v(t)<0||!_(e,t))},O=function(e){var t=parseInt(e.getAttribute("tabindex"),10)
return!!(isNaN(t)||t>=0)},E=function e(t){var n=[],o=[]
return t.forEach((function(t,r){var i=!!t.scope,a=i?t.scope:t,s=v(a,i),l=i?e(t.candidates):a
0===s?i?n.push.apply(n,l):n.push(a):o.push({documentOrder:r,tabIndex:s,item:t,isScope:i,content:l})})),o.sort(h).reduce((function(e,t){return t.isScope?e.push.apply(e,t.content):e.push(t.content),e}),[]).concat(n)},T=function(e,t){var n
...
var n,o,r,i,a,s,l,c,u,d,p,m,v,h,y,g,w,O,E
...
n&&n()
var u=function(){I((function(){c&&m(v(s.nodeFocusedBeforeActivation)),o&&o()}))}
return c&&i?(i(v(s.nodeFocusedBeforeActivation)).then(u,u),this):(u(),this)},pause:function(){return s.paused||!s.active||(s.paused=!0,E()),this},unpause:function(){return s.paused&&s.active?(s.paused=!1,p(),O(),this):this},updateContainerElements:function(e){var t=[].concat(e).filter(Boolean)
...
this.modal=null,o&&o(r)}hideModal(){this.modal?.close()}willDestroy(){this.hideModal(),super.willDestroy(...arguments)}}r=c,(0,s.g)(r.prototype,"modals",[a.inject])},338:(e,t,n)=>{"use strict"
n.r(t),n.d(t,{default:()=>m})
const o=require("@ember/array")
var r=n(886),i=n(208),a=n(672),s=n.n(a)
...
return this._stack.pushObject(o),1===this._stack.length&&this._onFirstModalAdded(),o},_destroyModals(){this._stack.forEach((e=>{e._destroy()}))},_onFirstModalAdded(){document.body.classList.add("epm-scrolling-disabled")},_onLastModalRemoved(){document.body.classList.remove("epm-scrolling-disabled")},_onModalAnimationStart(){document.body.classList.add("epm-animating")},_onModalAnimationEnd(){document.body.classList.remove("epm-animating")}})},296:e=>{"use strict"
e.exports=require("@ember/component")},886:e=>{"use strict"
e.exports=require("@ember/object")},208:e=>{"use strict"
e.exports=require("@ember/object/computed")},672:e=>{"use strict"
e.exports=require("@ember/service")},894:e=>{"use strict"
e.exports=require("@ember/template-factory")},408:(e,t,n)=>{e.exports=function(){var e=_eai_d,t=_eai_r
function o(e){return e&&e.__esModule?e:Object.assign({default:e},e)}window.emberAutoImportDynamic=function(e){return 1===arguments.length?t("_eai_dyn_"+e):t("_eai_dynt_"+e)(Array.prototype.slice.call(arguments,1))},window.emberAutoImportSync=function(e){return t("_eai_sync_"+e)(Array.prototype.slice.call(arguments,1))},e("ember-promise-modals/components/epm-modal",["@ember/component","@ember/object","@ember/object/computed","@ember/service","@ember/template-factory"],(function(){return o(n(840))})),e("ember-promise-modals/components/epm-modal-container",["@ember/component","@ember/service","@ember/template-factory"],(function(){return o(n(952))})),e("ember-promise-modals/helpers/open-modal",["@ember/service"],(function(){return o(n(854))})),e("ember-promise-modals/services/modals",["@ember/object","@ember/object/computed","@ember/service"],(function(){return o(n(338))}))}()},180:function(e,t){window._eai_r=require,window._eai_d=define},624:(e,t,n)=>{"use strict"
n.d(t,{g:()=>a,i:()=>c,n:()=>l})
