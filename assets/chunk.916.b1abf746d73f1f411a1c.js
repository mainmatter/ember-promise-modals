/*! For license information please see chunk.916.b1abf746d73f1f411a1c.js.LICENSE.txt */
...
for(var n=fe[e],r=n?l(n):[],i=0;i<r.length;i++)r[i](t)}var pe="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{}
function ge(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var me={exports:{}}
...
for(var i=0,s=e.length;i<s;i++)o.resolve(e[i]).then(t,r)}))},o._immediateFn="function"==typeof setImmediate&&function(e){setImmediate(e)}||function(e){t(e,0)},o._unhandledRejectionFn=function(e){"undefined"!=typeof console&&console&&console.warn("Possible Unhandled Promise Rejection:",e)},me.exports=o}else me.exports=e.Promise
...
n=!0,u(t,e)}}}()
var ve=me.exports
function be(e,t){var n=Y.callbacks[e]
if("log"!==e){var r=ve.resolve()
return n.forEach((function(e){r=r.then((function(){return ve.resolve(e(t))}))})),r}n.map((function(e){return e(t)}))}var ye,ke=0,we=[]
function xe(){var e,t
e=N.now(),Y.depth=(Y.depth||0)+1,Ee(e),Y.depth--,we.length||Y.blocking||Y.current||(Y.blocking||Y.queue.length||0!==Y.depth?(t=Y.queue.shift()(),we.push.apply(we,l(t)),ke>0&&ke--,xe()):function(){var e
if(0===Y.stats.testCount&&!0===Y.failOnZeroTests)return e=Y.filter&&Y.filter.length?new Error('No tests matched the filter "'.concat(Y.filter,'".')):Y.module&&Y.module.length?new Error('No tests matched the module "'.concat(Y.module,'".')):Y.moduleId&&Y.moduleId.length?new Error('No tests matched the moduleId "'.concat(Y.moduleId,'".')):Y.testId&&Y.testId.length?new Error('No tests matched the testId "'.concat(Y.testId,'".')):new Error("No tests were run."),Re("global failure",I((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void xe()
var t=Y.storage,n=Math.round(N.now()-Y.started),r=Y.stats.all-Y.stats.bad
Ce.finished=!0,he("runEnd",K.end(!0)),be("done",{passed:r,failed:Y.stats.bad,total:Y.stats.all,runtime:n}).then((function(){if(t&&0===Y.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}function Ee(e){if(we.length&&!Y.blocking){var t=N.now()-e
if(!g||Y.updateRate<=0||t<Y.updateRate){var n=we.shift()
ve.resolve(n()).then((function(){we.length?Ee(e):xe()}))}else g(xe)}}var Ce={finished:!1,add:function(e,t,n){if(t)Y.queue.splice(ke++,0,e)
...
var r=Math.floor(ye()*(Y.queue.length-ke+1))
Y.queue.splice(ke+r,0,e)}else Y.queue.push(e)},advance:xe,taskCount:function(){return we.length}},Te=function(){function e(t,n,r){o(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return a(e,[{key:"start",value:function(e){return e&&(this._startTime=N.now(),N.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=N.now(),N)){N.mark("qunit_test_end")
...
function Ne(e){if(this.expected=null,this.assertions=[],this.module=Y.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new k,this.nextPauseId=1,this.stackOffset=3,I(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),Ce.finished)x.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
...
this.testId=_(this.module.name,this.testName),++Ne.count,this.errorForStack=new Error,this.callback&&this.callback.validTest&&(this.errorForStack.stack=void 0),this.testReport=new Te(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()}),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new ue(this)}}function Me(){if(!Y.current)throw new Error("pushFailure() assertion outside test context, in "+ae(2))
var e=Y.current
return e.pushFailure.apply(e,arguments)}function Se(){if(Y.pollution=[],Y.noglobals)for(var e in d)if(C.call(d,e)){if(/^qunit-test-output/.test(e))continue
Y.pollution.push(e)}}Ne.count=0,Ne.prototype={get stack(){return se(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t),r=ve.resolve()
return n.forEach((function(e){r=r.then((function(){return e.stats={all:0,bad:0,started:N.now()},he("suiteStart",e.suiteReport.start(!0)),be("moduleStart",{name:e.name,tests:e.tests})}))})),r.then((function(){return Y.current=e,e.testEnvironment=I({},t.testEnvironment),e.started=N.now(),he("testStart",e.testReport.start(!0)),be("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){Y.pollution||Se()}))}))},run:function(){if(Y.current=this,Y.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,se(e,0)),Se(),Y.blocking&&Ae(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&Me("Test did not finish synchronously even though assert.timeout( 0 ) was used.",ae(2))}},after:function(){!function(){var e=Y.pollution
Se()
...
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof Ne))throw new Error("pushFailure() assertion outside test context, was "+ae(2))
this.pushResult({result:!1,message:e||"error",actual:n||null,source:t})},logAssertion:function(e){be("log",e)
...
i.remaining--,0===i.remaining&&n.pauses.delete(r),Le(n)}}return n.pauses.set(r,i),g&&("number"==typeof n.timeout?t=n.timeout:"number"==typeof Y.testTimeout&&(t=Y.testTimeout),"number"==typeof t&&t>0&&(Y.timeoutHandler=function(e){return function(){Y.timeout=null,i.cancelled=!0,n.pauses.delete(r),n.pushFailure("Test took longer than ".concat(e,"ms; test timed out."),ae(2)),Le(n)}},m(Y.timeout),Y.timeout=g(Y.timeoutHandler(t),t))),o},resolvePromise:function(e,t){if(null!=e){var n=this,r=e.then
...
n.pushFailure(r,se(e,0)),Se(),Ae(n)}))}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
...
var je=!1
function qe(e){je||Y.currentModule.ignored||new Ne(e).queue()}function Ie(e){Y.currentModule.ignored||(je||(Y.queue.length=0,je=!0),new Ne(e).queue())}function Re(e,t){qe({testName:e,callback:t})}function Oe(e,t){return"".concat(e," [").concat(t,"]")}function _e(e,t){if(Array.isArray(e))for(var n=0;n<e.length;n++)t(e[n],n)
else{if("object"!==i(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(i(e)," instead."))
for(var r in e)t(e[r],r)}}function Ae(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Le(e)}function Le(e){e.pauses.size>0||(g?(m(Y.timeout),Y.timeout=g((function(){e.pauses.size>0||(m(Y.timeout),Y.timeout=null,Y.blocking=!1,Ce.advance())}))):(Y.blocking=!1,Ce.advance()))}function Pe(e){for(var t=[].concat(e.tests),n=l(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,l(r.childModules))}return t}function He(e){return e.testsRun+e.testsIgnored===Pe(e).length}function Ue(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}I(Re,{todo:function(e,t){qe({testName:e,callback:t,todo:!0})},skip:function(e){qe({testName:e,skip:!0})},only:function(e,t){Ie({testName:e,callback:t})},each:function(e,t,n){_e(t,(function(t,r){qe({testName:Oe(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}}),Re.todo.each=function(e,t,n){_e(t,(function(t,r){qe({testName:Oe(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})}))},Re.skip.each=function(e,t){_e(t,(function(t,n){qe({testName:Oe(e,n),stackOffset:5,skip:!0})}))},Re.only.each=function(e,t,n){_e(t,(function(t,r){Ie({testName:Oe(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}
var De,Fe,Be,Qe,ze=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
De=Ge.FORCE_COLOR,Fe=Ge.NODE_DISABLE_COLORS,Be=Ge.NO_COLOR,Qe=Ge.TERM,$e=process.stdout&&process.stdout.isTTY}var Ye={enabled:!Fe&&null==Be&&"dumb"!==Qe&&(null!=De&&"0"!==De||$e),reset:Je(0,0),bold:Je(1,22),dim:Je(2,22),italic:Je(3,23),underline:Je(4,24),inverse:Je(7,27),hidden:Je(8,28),strikethrough:Je(9,29),black:Je(30,39),red:Je(31,39),green:Je(32,39),yellow:Je(33,39),blue:Je(34,39),magenta:Je(35,39),cyan:Je(36,39),white:Je(37,39),gray:Je(90,39),grey:Je(90,39),bgBlack:Je(40,49),bgRed:Je(41,49),bgGreen:Je(42,49),bgYellow:Je(43,49),bgBlue:Je(44,49),bgMagenta:Je(45,49),bgCyan:Je(46,49),bgWhite:Je(47,49)}
function We(e,t){for(var n,r=0,i="",o="";r<e.length;r++)i+=(n=e[r]).open,o+=n.close,~t.indexOf(n.close)&&(t=t.replace(n.rgx,n.close+n.open))
return i+t+o}function Je(e,t){var n={open:"[".concat(e,"m"),close:"[".concat(t,"m"),rgx:new RegExp("\\x1b\\[".concat(t,"m"),"g")}
return function(t){return void 0!==this&&void 0!==this.has?(~this.has.indexOf(e)||(this.has.push(e),this.keys.push(n)),void 0===t?this:Ye.enabled?We(this.keys,t+""):t+""):void 0===t?((r={has:[e],keys:[n]}).reset=Ye.reset.bind(r),r.bold=Ye.bold.bind(r),r.dim=Ye.dim.bind(r),r.italic=Ye.italic.bind(r),r.underline=Ye.underline.bind(r),r.inverse=Ye.inverse.bind(r),r.hidden=Ye.hidden.bind(r),r.strikethrough=Ye.strikethrough.bind(r),r.black=Ye.black.bind(r),r.red=Ye.red.bind(r),r.green=Ye.green.bind(r),r.yellow=Ye.yellow.bind(r),r.blue=Ye.blue.bind(r),r.magenta=Ye.magenta.bind(r),r.cyan=Ye.cyan.bind(r),r.white=Ye.white.bind(r),r.gray=Ye.gray.bind(r),r.grey=Ye.grey.bind(r),r.bgBlack=Ye.bgBlack.bind(r),r.bgRed=Ye.bgRed.bind(r),r.bgGreen=Ye.bgGreen.bind(r),r.bgYellow=Ye.bgYellow.bind(r),r.bgBlue=Ye.bgBlue.bind(r),r.bgMagenta=Ye.bgMagenta.bind(r),r.bgCyan=Ye.bgCyan.bind(r),r.bgWhite=Ye.bgWhite.bind(r),r):Ye.enabled?We([n],t+""):t+""
...
return"|\n"+c.join("\n")}var f=e.split("\n").map((function(e){return a+e}))
return"|+\n"+f.join("\n")}return e}return JSON.stringify(Ke(e),null,2)}function Ke(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(-1!==t.indexOf(e))return"[Circular]"
var n,r=Object.prototype.toString.call(e).replace(/^\[.+\s(.+?)]$/,"$1").toLowerCase()
switch(r){case"array":t.push(e),n=e.map((function(e){return Ke(e,t)})),t.pop()
break
case"object":t.push(e),n={},Object.keys(e).forEach((function(r){n[r]=Ke(e[r],t)})),t.pop()
break
default:n=e}return n}var Xe=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
n+="\n  message: ".concat(Ze(e.message||"failed")),n+="\n  severity: ".concat(Ze(t||"failed")),Ve.call(e,"actual")&&(n+="\n  actual  : ".concat(Ze(e.actual))),Ve.call(e,"expected")&&(n+="\n  expected: ".concat(Ze(e.expected))),e.stack&&(n+="\n  stack: ".concat(Ze(e.stack+"\n"))),n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
t+="\n  message: ".concat(Ze(A(e))),t+="\n  severity: ".concat(Ze("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Ze(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),et={console:ze,tap:Xe}
function tt(e){return function(t){Y.globalHooks[e]||(Y.globalHooks[e]=[]),Y.globalHooks[e].push(t)}}var nt={beforeEach:tt("beforeEach"),afterEach:tt("afterEach")}
function rt(e){Y.current?Y.current.assert.pushResult({result:!1,message:"global failure: ".concat(A(e)),source:e&&e.stack||ae(2)}):(K.globalFailureCount++,Y.stats.bad++,Y.stats.all++,he("error",e))}var it={}
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,rt(t),!1},onUncaughtException:rt,pushFailure:Me,assert:ue.prototype,module:ie,test:Re,todo:Re.todo,skip:Re.skip,only:Re.only,start:function(e){if(Y.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=ot
...
if(!Y.pageLoaded)return Y.autostart=!0,void(v||it.load())
at()},onUnhandledRejection:function(e){x.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),rt(e)},extend:function(){x.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return I.apply(this,t)},load:function(){Y.pageLoaded=!0,I(Y,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),st||(Y.blocking=!1,Y.autostart&&at())},stack:function(e){return ae(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
void 0===Y.callbacks[i]&&(Y.callbacks[i]=[]),e[i]=n(i)}}(it),function(i){if(h&&v){if(h.QUnit&&h.QUnit.version)throw new Error("QUnit has already been defined.")
...
var ct={exports:{}}
!function(e){var t,n
t=pe,n=function(){var e=void 0!==ge&&"undefined"==typeof window,t="function"==typeof Map?Map:function(){var e=Object.create(null)
...
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(h&&v){var e=it.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=S({filter:void 0,module:void 0,moduleId:void 0,testId:void 0}),o=null
it.on("runStart",(function(e){dt.defined=e.testCounts.total})),it.begin((function(t){!function(t){var n,s,a,u,c,f,p,y,E=C("qunit")
E&&(E.setAttribute("role","main"),E.innerHTML="<h1 id='qunit-header'>"+ht(v.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(n=it.config.testId)||n.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+ht(n.join(", "))+" <a id='qunit-clearFilter' href='"+ht(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(s=C("qunit-header"))&&(s.innerHTML="<a href='"+ht(i)+"'>"+s.innerHTML+"</a> "),(a=C("qunit-banner"))&&(a.className=""),p=C("qunit-tests"),(y=C("qunit-testresult"))&&y.parentNode.removeChild(y),p&&(p.innerHTML="",(y=v.createElement("p")).id="qunit-testresult",y.className="result",p.parentNode.insertBefore(y,p),y.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',c=C("qunit-testresult-controls")),c&&c.appendChild(((f=v.createElement("button")).id="qunit-abort-tests-button",f.innerHTML="Abort",d(f,"click",T),f)),(u=C("qunit-userAgent"))&&(u.innerHTML="",u.appendChild(v.createTextNode("QUnit "+it.version+"; "+b.userAgent))),function(t){var n,i,s,a,u,c=C("qunit-testrunner-toolbar")
...
if(s.value&&"string"!=typeof s.value){if(i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'>"+s.label+": </label><select id='qunit-urlconfig-"+a+"' name='"+a+"' title='"+u+"'><option></option>",Array.isArray(s.value))for(var l=0;l<s.value.length;l++)i+="<option value='"+(a=ht(s.value[l]))+"'"+(e[s.id]===s.value[l]?(t=!0)&&" selected='selected'":"")+">"+a+"</option>"
else for(var c in s.value)r.call(s.value,c)&&(i+="<option value='"+ht(c)+"'"+(e[s.id]===c?(t=!0)&&" selected='selected'":"")+">"+ht(s.value[c])+"</option>")
e[s.id]&&!t&&(i+="<option value='"+(a=ht(e[s.id]))+"' selected='selected' disabled='disabled'>"+a+"</option>"),i+="</select>"}else i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'><input id='qunit-urlconfig-"+a+"' name='"+a+"' type='checkbox'"+(s.value?" value='"+ht(s.value)+"'":"")+(e[s.id]?" checked='checked'":"")+" title='"+u+"' />"+ht(s.label)+"</label>"}return i}(),w(u,"qunit-url-config"),m(u.getElementsByTagName("input"),"change",M),m(u.getElementsByTagName("select"),"change",M),u))
...
o.selectedMap.has(r.moduleId)||(t+=q(r.moduleId,r.name,!1))}return t}(""===e?o.options.slice(0,20).map((function(e){return{obj:e}})):ft.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(s.value)}))}function M(e){var t=e&&e.target||null
...
p.className="clearfix",c.appendChild(f),c.appendChild(p)}}(t)}(t)})),it.on("runEnd",(function(t){var n,r,i,o=C("qunit-banner"),s=C("qunit-tests"),a=C("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",O(dt.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<s.children.length;c++)""!==(n=s.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=v.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!o||a&&!1!==a.disabled||(o.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),s&&(C("qunit-testresult-display").innerHTML=l),e.altertitle&&v.title&&(v.title=["failed"===t.status?"✖":"✔",v.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&h.scrollTo&&h.scrollTo(0,0)})),it.testStart((function(e){var t,n
R(e.name,e.testId,e.module),(t=C("qunit-testresult-display"))&&(w(t,"running"),n=it.config.reorder&&e.previousFailure,t.innerHTML=[L(dt),n?"Rerunning previously failed test: <br />":"Running: ",_(e.name,e.module),O(dt.failedTests)].join(""))})),it.log((function(e){var t=C("qunit-test-output-"+e.testId)
...
var a=!1
!e.result&&r.call(e,"expected")?(n=e.negative?"NOT "+it.dump.parse(e.expected):it.dump.parse(e.expected),i=it.dump.parse(e.actual),s+="<table><tr class='test-expected'><th>Expected: </th><td><pre>"+ht(n)+"</pre></td></tr>",i!==n?(s+="<tr class='test-actual'><th>Result: </th><td><pre>"+ht(i)+"</pre></td></tr>","number"==typeof e.actual&&"number"==typeof e.expected?isNaN(e.actual)||isNaN(e.expected)||(a=!0,o=((o=e.actual-e.expected)>0?"+":"")+o):"boolean"!=typeof e.actual&&"boolean"!=typeof e.expected&&(a=P(o=it.diff(n,i)).length!==P(n).length+P(i).length),a&&(s+="<tr class='test-diff'><th>Diff: </th><td><pre>"+o+"</pre></td></tr>")):-1!==n.indexOf("[object Array]")||-1!==n.indexOf("[object Object]")?s+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the depth of object is more than current max depth ("+it.config.maxDepth+").<p>Hint: Use <code>QUnit.dump.maxDepth</code> to  run with a higher max depth or <a href='"+ht(S({maxDepth:-1}))+"'>Rerun</a> without max depth.</p></td></tr>":s+="<tr class='test-message'><th>Message: </th><td>Diff suppressed as the expected and actual results have an equivalent serialization</td></tr>",e.source&&(s+="<tr class='test-source'><th>Source: </th><td><pre>"+ht(e.source)+"</pre></td></tr>"),s+="</table>"):!e.result&&e.source&&(s+="<table><tr class='test-source'><th>Source: </th><td><pre>"+ht(e.source)+"</pre></td></tr></table>")
var u=t.getElementsByTagName("ol")[0],l=v.createElement("li")
l.className=e.result?"pass":"fail",l.innerHTML=s,u.appendChild(l)}})),it.testDone((function(r){var i=C("qunit-tests"),o=C("qunit-test-output-"+r.testId)
if(i&&o){var s
...
b.innerHTML="<strong>Source: </strong>"+ht(r.source),w(b,"qunit-source"),c&&w(b,"qunit-collapsed"),d(f,"click",(function(){x(b,"qunit-collapsed")})),o.appendChild(b)}e.hidepassed&&("passed"===s||r.skipped)&&(t.push(o),i.removeChild(o))}})),it.on("error",(function(e){var t=R("global failure")
if(t){var n=ht(A(e))
...
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),it.config.queue.length=0,!1}function N(e){var t=C("qunit-filter-input")
...
for(var i in e=I(I({},it.urlParams),e))if(r.call(e,i)&&void 0!==e[i])for(var o=[].concat(e[i]),s=0;s<o.length;s++)t+=encodeURIComponent(i),!0!==o[s]&&(t+="="+encodeURIComponent(o[s])),t+="&"
return n.protocol+"//"+n.host+n.pathname+t.slice(0,-1)}function j(){var e=C("qunit-filter-input").value
h.location=S({filter:""===e?void 0:e,moduleId:l(o.selectedMap.keys()),module:void 0,testId:void 0})}function q(e,t,n){return'<li><label class="clickable'+(n?" checked":"")+'"><input type="checkbox" value="'+ht(e)+'"'+(n?' checked="checked"':"")+" />"+ht(t)+"</label></li>"}function R(e,t,n){var r=C("qunit-tests")
...
return a.className="qunit-assert-list",o.appendChild(a),r.appendChild(o),o}}function O(e){return 0===e.length?"":["<br /><a href='"+ht(S({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function _(e,t){var n=""
return t&&(n="<span class='module-name'>"+ht(t)+"</span>: "),n+"<span class='test-name'>"+ht(e)+"</span>"}function L(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function P(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),it.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
