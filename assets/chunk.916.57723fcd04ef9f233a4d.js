/*! For license information please see chunk.916.57723fcd04ef9f233a4d.js.LICENSE.txt */
...
var t=L.storage,n=T.now()-L.started,r=L.stats.all-L.stats.bad
...
T.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return q(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return this._endTime-this._startTime}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
...
this.runtime=T.now()-this.started,L.stats.all+=this.assertions.length,L.stats.testCount+=1,t.stats.all+=this.assertions.length
...
throw new Error("Assertion occurred after test finished.\n> Test: "+n+"\n> Message: "+t+"\n")}var r={module:this.module.name,name:this.testName,result:e.result,message:e.message,actual:e.actual,testId:this.testId,negative:e.negative||!1,runtime:T.now()-this.started,todo:!!this.todo}
...
Ge.on("runStart",(function(e){et.defined=e.testCounts.total})),Ge.begin((function(){var t,n,s,a,u,c,f,p,y,E,N;(c=C("qunit"))&&(c.setAttribute("role","main"),c.innerHTML="<h1 id='qunit-header'>"+tt(v.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(t=Ge.config.testId)||t.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+tt(t.join(", "))+" <a id='qunit-clearFilter' href='"+tt(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(n=C("qunit-header"))&&(n.innerHTML="<a href='"+tt(i)+"'>"+n.innerHTML+"</a> "),(s=C("qunit-banner"))&&(s.className=""),E=C("qunit-tests"),(N=C("qunit-testresult"))&&N.parentNode.removeChild(N),E&&(E.innerHTML="",(N=v.createElement("p")).id="qunit-testresult",N.className="result",E.parentNode.insertBefore(N,E),N.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',p=C("qunit-testresult-controls")),p&&p.appendChild(((y=v.createElement("button")).id="qunit-abort-tests-button",y.innerHTML="Abort",d(y,"click",T),y)),(a=C("qunit-userAgent"))&&(a.innerHTML="",a.appendChild(v.createTextNode("QUnit "+Ge.version+"; "+b.userAgent))),(u=C("qunit-testrunner-toolbar"))&&(u.appendChild(((f=v.createElement("span")).innerHTML=function(){for(var t=!1,n=e.urlConfig,i="",o=0;o<n.length;o++){var s=e.urlConfig[o]
...
i.id="qunit-modulefilter-search",i.autocomplete="off",d(i,"input",C),d(i,"input",E),d(i,"focus",E),d(i,"click",E)
...
f.textContent="Select none",f.type="button",f.title="Clear the current module selection",d(f,"click",(function(){o.selectedMap.clear(),T(),C()}))
...
b.id="qunit-modulefilter-dropdown",b.style.display="none",b.appendChild(p),b.appendChild(m),d(b,"change",T),a.appendChild(b),T()
var y,w=v.createElement("form")
function E(){function e(t){var n=w.contains(t.target)
27!==t.keyCode&&n||(27===t.keyCode&&n&&i.focus(),b.style.display="none",g(v,"click",e),g(v,"keydown",e),i.value="",C())}"none"===b.style.display&&(C(),b.style.display="block",d(v,"click",e),d(v,"keydown",e))}function C(){h.clearTimeout(y),y=h.setTimeout((function(){m.innerHTML=function(e){return function(e){var t=""
o.selectedMap.forEach((function(e,n){t+=I(n,e,!0)}))
for(var n=0;n<e.length;n++){var r=e[n].obj
o.selectedMap.has(r.moduleId)||(t+=I(r.moduleId,r.name,!1))}return t}(""===e?o.options.slice(0,20).map((function(e){return{obj:e}})):Xe.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(i.value)}))}function T(e){var t=e&&e.target||null
...
i.placeholder=n,i.title="Type to search through and reduce the list.",c.disabled=!o.isDirty(),f.style.display=o.selectedMap.size?"":"none"}return w.id="qunit-modulefilter",w.appendChild(s),w.appendChild(v.createTextNode(" ")),w.appendChild(a),d(w,"submit",M),d(w,"reset",(function(){o.selectedMap=new k(t),T(),C()})),w}()),s}()),u.appendChild(v.createElement("div")).className="clearfix")})),Ge.on("runEnd",(function(t){var n,r,i,o=C("qunit-banner"),s=C("qunit-tests"),a=C("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",Math.round(t.runtime)," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",_(et.failedTests)].join("")
