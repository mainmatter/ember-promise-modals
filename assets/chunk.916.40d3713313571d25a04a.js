/*! For license information please see chunk.916.40d3713313571d25a04a.js.LICENSE.txt */
...
if(L.currentModule=i,"function"==typeof n){D.push(i)
try{var l=n.call(i.testEnvironment,a)
l&&"function"==typeof l.then&&w.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{D.pop(),L.currentModule=i.parentModule||u}}}var G=!1
...
T.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return q(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return Math.round(this._endTime-this._startTime)}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
...
return n.reverse()}(t)
return n.reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:T.now()},ne("suiteStart",t.suiteReport.start(!0)),se("moduleStart",{name:t.name,tests:t.tests})}))}),oe.resolve([])).then((function(){return L.current=e,e.testEnvironment=q({},t.testEnvironment),e.started=T.now(),ne("testStart",e.testReport.start(!0)),se("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){L.pollution||me()}))}))},run:function(){if(L.current=this,L.notrycatch)e(this)
...
n.pushFailure(r,J(e,0)),me(),Ee(n)}))}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
...
for(var r in e)t(e[r],r)}}function Ee(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Ce(e)}function Ce(e){e.pauses.size>0||(g?(m(L.timeout),L.timeout=g((function(){e.pauses.size>0||(m(L.timeout),L.timeout=null,L.blocking=!1,de.advance())}))):(L.blocking=!1,de.advance()))}function Te(e){for(var t=[].concat(e.tests),n=l(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,l(r.childModules))}return t}function Me(e){return e.testsRun+e.testsIgnored===Te(e).length}function Se(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}q(ke,{todo:function(e,t){be({testName:e,callback:t,todo:!0})},skip:function(e){be({testName:e,skip:!0})},only:function(e,t){ye({testName:e,callback:t})},each:function(e,t,n){xe(t,(function(t,r){be({testName:we(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}}),ke.todo.each=function(e,t,n){xe(t,(function(t,r){be({testName:we(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})}))},ke.skip.each=function(e,t){xe(t,(function(t,n){be({testName:we(e,n),stackOffset:5,skip:!0})}))},ke.only.each=function(e,t,n){xe(t,(function(t,r){ye({testName:we(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}
...
ne("runStart",F.start(!0)),se("begin",{totalTests:pe.count,modules:e}).then(Ve)}}Ge.isLocal=h&&h.location&&"file:"===h.location.protocol,Ge.version="2.19.0",q(Ge,{config:L,dump:U,equiv:A,reporters:Be,hooks:ze,is:R,objectType:I,on:function(e,t){if("string"!=typeof e)throw new TypeError("eventName must be a string when registering a listener")
...
function n(e){return function(t){if("function"!=typeof t)throw new Error("QUnit logging methods require a callback function as their first parameters.")
L.callbacks[e].push(t)}}for(var r=0,i=t.length;r<i;r++){var o=t[r]
void 0===L.callbacks[o]&&(L.callbacks[o]=[]),e[o]=n(o)}}(Ge),function(i){if(h&&v){if(h.QUnit&&h.QUnit.version)throw new Error("QUnit has already been defined.")
...
for(var T=n[m],M=new Array(C),S=C-1;S>=0;--S)(q=c(T,j=E[S]))?(f(q)||(q=p.getPrepared(q)),M[S]=y(t,q,h)):M[S]=null
M.obj=T
var N=d(M)
...
E&&(E.setAttribute("role","main"),E.innerHTML="<h1 id='qunit-header'>"+tt(v.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(n=Ge.config.testId)||n.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+tt(n.join(", "))+" <a id='qunit-clearFilter' href='"+tt(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(s=C("qunit-header"))&&(s.innerHTML="<a href='"+tt(i)+"'>"+s.innerHTML+"</a> "),(a=C("qunit-banner"))&&(a.className=""),p=C("qunit-tests"),(y=C("qunit-testresult"))&&y.parentNode.removeChild(y),p&&(p.innerHTML="",(y=v.createElement("p")).id="qunit-testresult",y.className="result",p.parentNode.insertBefore(y,p),y.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',c=C("qunit-testresult-controls")),c&&c.appendChild(((f=v.createElement("button")).id="qunit-abort-tests-button",f.innerHTML="Abort",d(f,"click",T),f)),(u=C("qunit-userAgent"))&&(u.innerHTML="",u.appendChild(v.createTextNode("QUnit "+Ge.version+"; "+b.userAgent))),function(t){var n,i,s,a,u,c=C("qunit-testrunner-toolbar")
...
p.textContent="Select none",p.type="button",p.title="Clear the current module selection",d(p,"click",(function(){o.selectedMap.clear(),S(),T()}))
...
o.selectedMap.has(r.moduleId)||(t+=I(r.moduleId,r.name,!1))}return t}(""===e?o.options.slice(0,20).map((function(e){return{obj:e}})):Xe.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(s.value)}))}function S(e){var t=e&&e.target||null
...
s.placeholder=n,s.title="Type to search through and reduce the list.",f.disabled=!o.isDirty(),p.style.display=o.selectedMap.size?"":"none"}return E.id="qunit-modulefilter",E.appendChild(a),E.appendChild(v.createTextNode(" ")),E.appendChild(u),d(E,"submit",M),d(E,"reset",(function(){o.selectedMap=new k(n),S(),T()})),E}(t)),v.createElement("div").className="clearfix",c.appendChild(f),c.appendChild(v.createElement("div"))}}(t)}(t)})),Ge.on("runEnd",(function(t){var n,r,i,o=C("qunit-banner"),s=C("qunit-tests"),a=C("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",_(et.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<s.children.length;c++)""!==(n=s.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=v.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!o||a&&!1!==a.disabled||(o.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),s&&(C("qunit-testresult-display").innerHTML=l),e.altertitle&&v.title&&(v.title=["failed"===t.status?"✖":"✔",v.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&h.scrollTo&&h.scrollTo(0,0)})),Ge.testStart((function(e){var t,n
R(e.name,e.testId,e.module),(t=C("qunit-testresult-display"))&&(w(t,"running"),n=Ge.config.reorder&&e.previousFailure,t.innerHTML=[L(et),n?"Rerunning previously failed test: <br />":"Running: ",A(e.name,e.module),_(et.failedTests)].join(""))})),Ge.log((function(e){var t=C("qunit-test-output-"+e.testId)
...
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),Ge.config.queue.length=0,!1}function M(e){var t=C("qunit-filter-input")
...
h.location=N({filter:""===e?void 0:e,moduleId:l(o.selectedMap.keys()),module:void 0,testId:void 0})}function I(e,t,n){return'<li><label class="clickable'+(n?" checked":"")+'"><input type="checkbox" value="'+tt(e)+'"'+(n?' checked="checked"':"")+" />"+tt(t)+"</label></li>"}function R(e,t,n){var r=C("qunit-tests")
...
a+=i.length}u=0,l=0,f="",c=""}a++}return o.pop(),o},e.prototype.diffBisect=function(e,n,r){var i,o,s,a,u,l,c,f,d,h,p,g,m,v,b,y,k,w,x,E,C,T,M
for(i=e.length,o=n.length,a=s=Math.ceil((i+o)/2),u=2*s,l=new Array(u),c=new Array(u),f=0;f<u;f++)l[f]=-1,c[f]=-1
for(l[a+1]=0,c[a+1]=0,h=(d=i-o)%2!=0,p=0,g=0,m=0,v=0,C=0;C<s&&!((new Date).getTime()>r);C++){for(T=-C+p;T<=C-g;T+=2){for(y=a+T,x=(k=T===-C||T!==C&&l[y-1]<l[y+1]?l[y+1]:l[y-1]+1)-T;k<i&&x<o&&e.charAt(k)===n.charAt(x);)k++,x++
if(l[y]=k,k>i)g+=2
else if(x>o)p+=2
else if(h&&(b=a+d-T)>=0&&b<u&&-1!==c[b]&&k>=(w=i-c[b]))return this.diffBisectSplit(e,n,k,x,r)}for(M=-C+m;M<=C-v;M+=2){for(b=a+M,E=(w=M===-C||M!==C&&c[b-1]<c[b+1]?c[b+1]:c[b-1]+1)-M;w<i&&E<o&&e.charAt(i-w-1)===n.charAt(o-E-1);)w++,E++
if(c[b]=w,w>i)v+=2
else if(E>o)m+=2
