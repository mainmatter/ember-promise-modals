...
module('Service | modals', function (hooks) {
  ...
  test('modals do not show up in openCount when closing', async function (assert) {
    ...
    assert.strictEqual(modals.count, 1);

    modal._resolve();

    assert.strictEqual(modals.count, 0);
